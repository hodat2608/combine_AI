...
def hien_thi(pics):
    ...
    if myresult1 == 0:
        ...
        for i in hm:
            print('NG')
            cv2.putText(show_1, 'NG',(result_width_display,result_height_display),cv2.FONT_HERSHEY_COMPLEX, 3,(0,0,255),5)
...
def make_window(theme):
    ...
    layout_cam1 = [
       [
        sg.Frame('PATH',[
            ...
            [sg.Column([[sg.Text('', size=(10, 50), key='-OUTPUT8-')]], key='-COL2-')]
                    ]),
    ...
    layout_option2_0 = [
        ...
        [   
            ...
            sg.Frame('',[
                [sg.Button('Change Model', size=(14,1), font=('Helvetica',10), disabled= True, key= 'Change_2'),sg.Checkbox('tichvodaydemokhoa',size=(2,5),enable_events=True,default=False, font=('Helvetica',15),  key='checkboxpass'),]
            ], relief= sg.RELIEF_FLAT),],
...
try:
    while True:
        ...
        if event == 'checkboxpass' and values['checkboxpass'] == True:
            ...
            for i3 in range(len(model3.names)):
                ...
                window[f'{model3.names[i3]}_PLC_3'].update(disabled=False)
        # else:
        if event == 'checkboxpass' and values['checkboxpass'] == False:
