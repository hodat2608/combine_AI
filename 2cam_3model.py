...
import os, cv2, time, datetime, shutil
import  torch
import numpy as np 
import pandas as pd
...
def removefile():
    directory1 = 'C:/Users/CCSX009/Desktop/FH/CAM2/**/*'
    directory2 = 'C:/Users/CCSX009/Desktop/FH/CAM2/**/*'
...
def program_camera1_FH(model,size,conf,regno):
    ...
    if read_D == 1:
        dir_path = 'C:/Users/CCSX009/Desktop/FH/CAM1/**/*.jpg'
        ...
        if len(filenames) == 0:
            ...
            for filename1 in filenames:
                ...
                for item in range(len(table1.index)):
                    ...
                    if label_name == 'buichi':
                        ktr.append([table1['xmin'][item],table1['xmax'][item],table1['ymin'][item],table1['ymax'][item]])
                        toado.append([table1['xmin'][item],table1['xmax'][item],table1['ymin'][item],table1['ymax'][item]])
                ...
                if len(ktc) == 2:
                    ...
                    for e1 in el1:
                        for e2 in el2:
                            if abs(e1[0] - e2[0]) < 0.05 and abs(e1[1] - e2[1]) < 0.05 and abs(e1[3] - e2[3]) < 0.05 and abs(e1[4] - e2[4]) < 0.05:
                                mycount +=1
                                ktc.pop(0)
...
def program_camera2_FH(model,size,conf,file):
    ...
    while type(img2_orgin) == type(None):
        print('loading img 2...', file, type(img2_orgin))
    ...
    shutil.rmtree('C:/Users/CCSX009/Desktop/FH/CAM2/CHAU' + str(cd))
...
def program_camera3_FH(model,size,conf,file):
    ...
    shutil.rmtree('C:/Users/CCSX009/Desktop/FH/CAM2/CHOI' + str(tc))
...
try:
    while True:
        ...
        try:
            ...
            folder1 = glob('C:/Users/CCSX009/Desktop/FH/CAM2/CHAU1/**/*.jpg')#1
            folder3 = glob('C:/Users/CCSX009/Desktop/FH/CAM2/CHAU2/**/*.jpg')
            folder2 = glob('C:/Users/CCSX009/Desktop/FH/CAM2/CHOI1/**/*.jpg')
            folder4 = glob('C:/Users/CCSX009/Desktop/FH/CAM2/CHOI2/**/*.jpg')
            ...
            if event == 'check_model1' and values['check_model1'] == True or plc.read_word('D',aaaaaaaa) ==1:
                ...
                if os.listdir(directory1) == []:
                    ...
                    for path1 in bomau:
                        ...
                        img1_orgin = cv2.imread(program_camera1_FHpath1)
                        img1_orgin = cv2.cvtColor(img1_orgin, cv2.COLOR_BGR2RGB)     
