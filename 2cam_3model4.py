...
try:
    while True:
        ...
        if read_D == 1:   
            ...
            for f2 in folder2:
                tc =1
                program_camera3_FH(model=model3,size=416,conf=values['conf_thres3']/100, file = f2)                 
                
            for f3 in folder3:
                cd =2
                program_camera2_FH(model=model2,size=416,conf=values['conf_thres2']/100, file = f3)     
                
            for f4 in folder4:
                tc=2
                program_camera3_FH(model=model3,size=416,conf=values['conf_thres3']/100, file = f4)                 
