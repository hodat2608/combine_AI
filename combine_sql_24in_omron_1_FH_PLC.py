    ...
    layout_main = [
        ...
        sg.Frame('',[
            ...
            sg.Frame('',[
                ...
                [sg.Text('')],
                [sg.Input('0',size=(8,1),font=('Helvetica',15),key= 'Num_index',text_color='navy',enable_events=True)],
                [sg.Text('')],
...
image_width_display = int(760*1.9/2)
image_height_display = int(480*1.9/2)
...
#for path1 in glob.glob(r'D:\A47-A19-A02-09_09_2022\DETECT\cam1\ok\*'):
for path1 in glob.glob('F:/X75/bc_thiet/XOAY/*'):
##for path1 in glob.glob(r'\\d8730121\A47-A19-29-09-2022\cam1\ng from ok\*'):
    if path1[-3:] != 'txt':
