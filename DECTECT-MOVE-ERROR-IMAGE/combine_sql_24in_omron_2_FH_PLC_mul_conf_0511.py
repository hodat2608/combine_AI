...
#05092022
register_2020 = (2020).to_bytes(2, byteorder='big') + b'\x00'
fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,register_2020,b'\x00\x01',1)
#end
...
try:
    while True:
        ...
        #05092022
        register_2026 = (2026).to_bytes(2, byteorder='big') + b'\x00'
        read_2026 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,register_2026)
        if read_2026 == 0:
            break
        #end 
                    ...
                    if row1_a == '1':
                        for item in range(len(model1.names)):
                            if int(row1_b) == item:
                                ...
                                window[f'{model1.names[item]}_Conf_1'].update(value=str(row[22]))
                    ...
                    if row1_a == '2':
                        for item in range(len(model2.names)):
                            if int(row1_b) == item:
                                ...
                                window[f'{model2.names[item]}_PLC_2'].update(value=str(row[20]))
                                window['PLC_OK_2'].update(value=str(row[21]))
                                window[f'{model2.names[item]}_Conf_2'].update(value=str(row[22]))
        ...
        #05092022
        register_2022 = (2022).to_bytes(2, byteorder='big') + b'\x00'
        register_2024 = (2024).to_bytes(2, byteorder='big') + b'\x00'
        read_2022 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,register_2022)
        read_2024 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,register_2024)
        if read_2022 == b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x01' and read_2024 == b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x01':
            window['choose_model'].update(value='A22')
                    ...
                    if row1_a == '1':
                        for item in range(len(model1.names)):
                            if int(row1_b) == item:
                                ...
                                window[f'{model1.names[item]}_Hx_1'].update(value=str(row[19]))
                                window[f'{model1.names[item]}_PLC_1'].update(value=str(row[20]))
                                window['OK_PLC_1'].update(value=str(row[21]))
                                window[f'{model1.names[item]}_Conf_1'].update(value=str(row[22]))
                    ...
                    if row1_a == '2':
                        for item in range(len(model2.names)):
                            if int(row1_b) == item:
                                ...
                                window[f'{model2.names[item]}_Hx_2'].update(value=str(row[19]))
                                window[f'{model2.names[item]}_PLC_2'].update(value=str(row[20]))
                                window['OK_PLC_2'].update(value=str(row[21]))
                                window[f'{model2.names[item]}_Conf_2'].update(value=str(row[22]))


            conn.close()
            fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,register_2024,b'\x00\x00',1)
        # print('2022 ',read_2022)
        # print('2024 ',read_2024)
                        
        if read_2022 == b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x02' and read_2024 == b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x01':
            window['choose_model'].update(value='A19')
    ...
    #05092022
    fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,register_2020,b'\x00\x00',1)
