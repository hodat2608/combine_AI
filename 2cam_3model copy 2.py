...
mycount = 0 
toado1=[]
def program_camera_1_FH(model,size,conf,regno):
                        ...
                        if model1.names[i1] in names1:
                            if model1.names[i1] == 'bui_chi':
                                ...
                                if toa_do_y < 300 and toa_do_x < 1190:
                                    print('buichi choi tren')
                                    # plc.write_word('D',register_ng,1)
                                    break 
                                elif toa_do_y > 900 and toa_do_x < 1190:
                                    print('buichi choi duoi')
                                    # plc.write_word('D',register_ng,2)
                                    break
                                elif toa_do_x < 300 and toa_do_y < 1190:
                                    print('buichi chau trai')
                                    # plc.write_word('D',register_ng,3)
                                    break
                                elif toa_do_x > 900 and toa_do_y < 1190:
                                    print('buichi chau phai')
                                    # plc.write_word('D',register_ng,4)
                                    break
                                else :
...
try:
    while True:
        ...
        try:
            ...
            folder1 = glob('C:/FH/camera2/CHAU1/**/*.jpg')#1
